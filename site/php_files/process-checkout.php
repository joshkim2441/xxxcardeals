...
$insurance = 0;
$transport = 0;
if (isset($_POST['transport']) && isset($_POST['insurance'])) {
    $transport = explode(',', $_POST['transport']); // Convert comma-separated string to array
...
if (! empty($cartItem)) {
    if (! empty($cartItem)) {
        foreach ($cartItem as $item) {
            ...
            $item_price += ($transport + $insurance);
            //$insurance = $_POST['insurance'];
...
<div id="shopping-cart">
        <div class="txt-heading">
            <div class="txt-heading-label">xXx Shopping CARt</div>
