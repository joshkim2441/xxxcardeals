...
class ShoppingCart extends DBController
{
    ...
    function addToCart($product_id, $quantity, $member_id, $transport, $insurance)
    {
        $query = "INSERT INTO tbl_cart (product_id,quantity,member_id,transport,insurance) VALUES (?, ?, ?, ?, ?)";
    ...
    function insertOrderItem($order, $product_id, $price, $quantity, $transport, $insurance)
    {
        $query = "INSERT INTO tbl_order_item (order_id, product_id, item_price, quantity, transport, insurance) VALUES (?, ?, ?, ?, ?, ?)";
