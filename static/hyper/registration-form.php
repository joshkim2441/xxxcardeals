<div id="register-dialog" class="register-class"
    ...
    <form id="register-form" action="" method="post" role="form">
        ...
        <div class="input-row">
            <span id="company-info"></span> <input type="text"
                name="company" id="company" class="input-field"
                placeholder="Company" value="">
        </div>
        <div class="input-row">
            <span id="title-info"></span> <input type="text"
                name="title" id="title" class="input-field"
