...
def do_pack():
    ...
    print("static packed: {} -> {} Bytes".format(file_path, archive_size))
    return file_path
...
def do_deploy(archive_path):
    ...
    try:
        ...
        run('rm -rf /data/static/current')
        run('ln -s {}{}/ /data/static/current'.format(path, no_ext))
        return True
    except Exception:
        return False
