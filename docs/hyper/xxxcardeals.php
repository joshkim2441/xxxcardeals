...
<head>
  ...
  <ink rel="stylesheet" href="../styles/stylecp.css">
    ...
    <script language="JavaScript" src="../scripts/myservices.js" type="text/javascript"></script>
    <script>
...
<body>
  ...
  <fieldset>
        ...
        <div class="input-icons">
          ...
          <form id="modal_feedback" method="POST" action="send_contact_mail.php" accept-charset="UTF-8">
            <p><label>Your Name<strong></strong><br><i class="material-icons prefix">account_circle</i></style>
                <input type="text" style="text-align:center;" class="input-field" autofocus required
                  title="Enter your full names" size="400" name="name" value=""></label></p>
            <p><label>Email Address<strong></strong><br><i class="small material-icons prefix">email</i>
                <input type="email" style="text-align:center;" class="input-field" required
                  title="Please enter a valid email address" size="100" name="email" value=""></label></p>
            ...
            <p><input type="submit" formreset="modal_feedback"
                onclick="document.getElementById('modal_close').addEventListener('click', closeModal) name="
                feedbackForm" value="Send Message"></p>
          </form>
        </div>
      </div> <!-- #modal_window -->
    </div> <!-- #modal_wrapper -->
    ...
    <div>
      ...
      <ul>
        <li id="list">Astons Ferraris Royces Lambos and many more</li>
        ...
        <li id="list">Other Makes</li>
        <ol>
          <li>Bentley Mulliner Batur</li>
          <li>Czinger 21C</li>
          <li>Deus Vayanne</li>
          <li>Devel Sixteen</li>
          <li>Koenigsegg Gemera</li>
          <li>McLaren Elva</li>
          <li>McLaren Senna GTR</li>
          <li>SSC Tuatara</li>
          <li>W Motors Fenny SuperSport</li>
        </ol>
      </ul>
  </fieldset>
  </div>
  ...
  <table>
    ...
    <tr>
      <td>Aston Martin DBS 770</td>
      <td>$450,000</td>
      <td><img src='../product/Aston_Martin_DBS_770_Ultimate_$450k.jpg' width="100" height="50"></td>
    </tr>
    <tr>
      <td>Aston Martin Vantage GT3</td>
      <td>$726,000</td>
      <td><img src='../product/Aston_Martin_Vantage_GT302_$726k.png' width="100" height="50"></td>
    </tr>
    <tr>
      <td>Aston Martin Valour</td>
      <td>$2,000,000</td>
      <td><img src='../product/aston_martin_valour_2m.jpg' width="100" height="50"></td>
    </tr>
    <tr>
      <td>Ferrari 812 GTS</td>
      <td>$430,000</td>
      <td><img src='../product/Ferrari_812_GTS_$430k.jpg' width="100" height="50"></td>
    </tr>
    <tr>
      <td>Ferrari Purosangue</td>
      <td>$400,000</td>
      <td><img src='../product/Ferrari_Purosangue_$400k.jpg' width="100" height="50"></td>
    </tr>
    <tr>
      <td>Ferrari SF90 Stradale</td>
      <td>$570,000</td>
      <td><img src='../product/Ferrari_SF90_Stradale_$570.jpg' width="100" height="50"></td>
    </tr>
    <tr>
      <td>Ferrari SF90 XX Stradale</td>
      <td>$900,000</td>
      <td><img src='../product/Ferrari_SF90_XX_Stradale_$900k.png' width="100" height="50"></td>
    </tr>
    <tr>
      <td>Lamborghini Revuelto</td>
      <td>$890,000</td>
      <td><img src='../product/Lamborghini_Revuelto_$890.jpg' width="100" height="50"></td>
    </tr>
    <tr>
      <td>Rolls Royce Cullinan Black Badge</td>
      <td>$425,000</td>
      <td><img src='../product/Rolls_Royce_Cullinan_Black_Badge_$425k.jpg' width="100" height="50"></td>
    </tr>
    <tr>
      <td>Rolls Royce Ghost Black Badge</td>
      <td>$443,000</td>
      <td><img src='../product/Rolls_Royce_Ghost_Black_Badge_$443k.jpg' width="100" height="50"></td>
    </tr>
    <tr>
      <td>Rolls Royce Phantom</td>
      <td>$458,000</td>
      <td><img src='../product/Rolls_Royce_Phantom_$458k.png' width="100" height="50"></td>
    </tr>
    <tr>
      <td>Rolls Royce Ghost Spectre</td>
      <td>$440,000</td>
      <td><img src='../product/Rolls_Royce_Spectre_$440k.jpg' width="100" height="50"></td>
    </tr>
    <tr>
      <td>Bentley Mulliner Batur</td>
      <td>$2,100,000</td>
      <td><img src='../product/Bentley_Mulliner_Batur_2.1m.jpg' width="100" height="50"></td>
    </tr>
    <tr>
      <td>Czinger 21C</td>
      <td>$1,700,000</td>
      <td><img src='../product/czinger_21c_1.7m.jpg' width="100" height="50"></td>
    </tr>
    <tr>
      <td>Deus Vayanne</td>
      <td>$2,000,000</td>
      <td><img src='../product/deus_vayanne_2m.jpg' width="100" height="50"></td>
    </tr>
    <tr>
      <td>Devel Sixteen</td>
      <td>$1,700,000</td>
      <td><img src='../product/Devel_Sixteen_1.7m.jpg' width="100" height="50"></td>
    </tr>
    <tr>
      <td>Gordon Murray T33</td>
      <td>$1,700,000</td>
      <td><img src='../product/Gordon_Murray_T33_1.7m.jpg' width="100" height="50"></td>
    </tr>
    <tr>
      <td>Hispano Suiza Carmen</td>
      <td>$1,700,000</td>
      <td><img src='../product/hispano_suiza_carmen_1.7m.jpg' width="100" height="50"></td>
    </tr>
    <tr>
      <td>Koenigsegg Gemera</td>
      <td>$1,700,000</td>
      <td><img src='../product/Koenigsegg_Gemera_1.7m.jpg' width="100" height="50"></td>
    </tr>
    <tr>
      <td>McLaren Elva</td>
      <td>$1,700,000</td>
      <td><img src='../product/McLaren_Elva_1.7.jpg' width="100" height="50"></td>
    </tr>
    <tr>
      <td>McLaren Senna GTR</td>
      <td>$1,800,000</td>
      <td><img src='../product/McLaren_Senna_GTR_1.8m.jpg' width="100" height="50"></td>
    </tr>
    <tr>
      <td>SSC Tuatara</td>
      <td>$2,000,000</td>
      <td><img src='../product/SSC_Tuatara_2m.jpg' width="100" height="50"></td>
    </tr>
    <tr>
      <td>W Motors Fenyr SuperSport</td>
      <td>$1,400,000</td>
      <td><img src='../product/W_Motors_Fenyr_SuperSport_1.4m.jpg' width="100" height="50"></td>
    </tr>
  ...
  <fieldset>
    ...
    <p>In a case where the vehicle has to be shipped, you can choose the type of delevery service and insurance both of
  ...
  <script type="text/javascript" src="scripts/myservices.js"></script>
  ...
  <form id="products" method="POST" action="ppindex.php">
    ...
    <br />
    <br />
    <p>For other unspecified needs that have not been listed above, please feel free to email with the specific details
      of your requirements and you will receive an immediate response. 📧</p>

    <div class="form-popup" id="myForm" style="display:none">
      <div class="phppot-container tile-container" id="align-right" style="display:none">
        <form name="frmChange" method="post" action="/action_page.php" class="form-container"
          ...
          <div class="row">
            <label class="inline-block">Current Password</label> <span id="currentPassword"
              class="validation-message"></span> <input type="password" name="currentPassword" class="full-width"
              id="myInput">
          </div>
          <div class="row">
            <label class="inline-block">New Password</label> <span id="newPassword"
              class="validation-message"></span><input type="password" name="newPassword" class="full-width"
              id="myInput">
          </div>
          <div class="row">
            <label class="inline-block">Confirm Password</label> <span id="confirmPassword"
              class="validation-message"></span><input type="password" name="confirmPassword" class="full-width"
              id="myInput">
          </div>
          <div class="row">
  ...
  <script rel="application/JavaScript" src="../scripts/myservices.js"></script>
  <script>
    function openForm() {
      document.getElementById("align-right").style.display = "block";
